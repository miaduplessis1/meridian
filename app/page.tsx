  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] text-[#172033]">
      ...
      <main className="mx-auto max-w-[1440px] px-6 py-10 lg:px-12 lg:py-14">
        ...
        <section aria-labelledby="preview-heading" className="mt-10"><div className="mb-4 flex items-end justify-between"><div><p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#8994a5]">Output</p><h2 id="preview-heading" className="text-[20px] font-semibold tracking-[-0.02em] text-[#1b2940]">Proposal preview</h2></div><span className="hidden text-[12px] text-[#9aa3b2] sm:block">Preview will appear here</span></div><div className="flex min-h-[800px] items-center justify-center rounded-xl border border-dashed border-[#cfd6e0] bg-white shadow-[0_2px_8px_rgba(20,35,61,0.02)]"><div className="text-center"><div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-xl border border-[#e4e8ee] bg-[#fafbfd] text-[#a3adba]" aria-hidden="true">▤</div><p className="text-[14px] font-medium text-[#768296]">Proposal preview</p><p className="mt-1 text-[12px] text-[#a4acb8]">The generated proposal will be embedded here.</p></div></div></section>
      </main>
    </div>
  )
}
